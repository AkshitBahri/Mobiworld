...
<center>
<div style="height:400px;width:1450px;margin-top:30px;background-color:skyblue;margin-left:6px;">
			...
			<label style="margin-left:140px">Message</label>
			<input type="message" name="message" value=""/ style="margin-top:-5px;margin-left:27px;height:100px;width:300px"><br><br>
			
	        <input type="submit" name="submit" value="submit">
</div></center>
</form>
<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3379.525437228118!2d76.27360081493045!3d32.109109281178775!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x391b4f86bdf7fbed%3A0xbc581ec7302a9cad!2sGovernment+Polytechnic+College!5e0!3m2!1sen!2sus!4v1534066286732" width="1450" height="450" frameborder="0" style="border:0;margin-left:20px;margin-top:-16px" allowfullscreen></iframe>
...
<p align="center"style="margin-top:-5px;">+91 86290-14355</p></div>
...
<p align="center"style="margin-top:-5px;">Vill.Natehar,P.O.Kangra,Teh.&Distt.Kangra(HP)176001</p></div></div>
</body>
</html>
<?php
...
$email=$_POST['email'];
$conn=mysql_query("INSERT INTO contactus(`username`,`message`,`email`) VALUES('$username','$message','$email')")or die(mysql_error());
if($conn)
{
	echo 'data enter';
}
